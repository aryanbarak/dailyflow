...
export function buildReasoningPrompt(input: AgentReasoningPromptInput) {
  ...
  return [
    ...
    "If a message names more than one of repositories, issues, pull requests, or workflow runs, propose ask_clarification with candidates listing the specific ones it could mean, instead of guessing which one it means.",

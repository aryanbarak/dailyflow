...
// 17c, PO decision D1; revised again by PO decision 2026-09-05, ChatGPT-
// style compact pass). Pure auto-grow math for the composer textarea: a
// 1-line minimum (was 2 under D1 -- the PO judged the resting composer too
// tall against the ChatGPT reference), ~5 lines maximum (17a's original
// cap, unchanged), then internal scroll takes over. Kept separate from the
// DOM-measurement code (which lives in ChatComposer.tsx, reading
